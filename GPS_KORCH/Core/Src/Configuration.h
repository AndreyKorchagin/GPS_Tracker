...
//#define ADDRESS_TIME 0x0801F
//#define ADDRESS_LATITUDE 0x0801FC06
#define ADDRESS_LATITUDE 0x0801FC10
...
void ConvertToXY(float latitude, float longitude, float *ptrx, float *ptry) {
	...
	*ptrx =
			A * latitude
					- sin2latit
							* (16002.89 + 66.9607 * sinlatit2
									+ 0.3515 * sinlatit4
									- l2
											* (1594561.25 + 5336.535 * sinlatit2
													+ 26.790 * sinlatit4
													+ 0.149 * sinlatit6
													+ l2
															* (672483.4
	...
	*ptry =
			(5 + 10 * n) * 100000
					+ l * cos(latitude)
							* (6378245 + 21346.1415 * sinlatit2
									+ 107.1590 * sinlatit4 + 0.5977 * sinlatit6
									+ l2
											* (1070204.16
													- 2136826.66 * sinlatit2
													+ 17.98 * sinlatit4
													- 11.99 * sinlatit6
													+ l2
															* (270806
